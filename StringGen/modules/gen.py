...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@preetmodz"))
        else:
            ...
            await client.join_chat("preetmodz")
    except KeyError:
        pass
    try:
